...
import shmoozTheme from 'assets/scss/_shmooz.module.scss';
...
const PresetColor = () => {
    ...
    const colorOptions = [
        ...
        {
            id: 'shmoozTheme',
            primary: theme.palette.mode === 'dark' ? shmoozTheme.darkPrimaryMain : shmoozTheme.primaryMain,
            secondary: theme.palette.mode === 'dark' ? shmoozTheme.darkSecondaryMain : shmoozTheme.secondaryMain
        }
    ];
