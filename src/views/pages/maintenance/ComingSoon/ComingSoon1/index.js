                            ...
                            <Grid container spacing={gridSpacing}>
                                ...
                                <Grid item xs={12}>
                                    <Grid container spacing={2}>
                                        ...
                                        <Grid item xs={12}>
                                            <Typography sx={{ fontSize: '1.125rem' }}>Shmooz Admin</Typography>
                                        </Grid>
                                    </Grid>
                                </Grid>
                                <Grid item xs={12}>
                                            ...
                                            <Grid container justifyContent="space-between" spacing={gridSpacing}>
                                                <Grid item xs={12}>
                                                    <Grid container justifyContent="flex-end" spacing={1}>
                                                        ...
                                                        <Grid item>
                                                            <ButtonBase
                                                                component={Link}
                                                                href="https://www.facebook.com/shmooz"
                                                                target="_blank"
                                                                aria-label="facebook"
                                                            >
                                                                <Avatar
                                                        ...
                                                        <Grid item>
                                                            <ButtonBase
                                                                component={Link}
                                                                href="https://dribbble.com/shmooz"
                                                                target="_blank"
                                                                aria-label="dribble"
                                                            >
                                                                <Avatar
                                                ...
                                                <Grid item xs={12}>
                                                    <Grid container alignItems="center" justifyContent="flex-end" spacing={1}>
                                                        ...
                                                        <Grid item>
                                                            <img src={companyLogo} alt="Shmooz" width="128" />
                                                        </Grid>
                                                    </Grid>
                                                </Grid>
                                            </Grid>
