...
import SliderDashboardLight from 'assets/images/landing/pre-apps/slider-dashboard-light.png';

import SliderDashboardDark from 'assets/images/landing/pre-apps/slider-dashboard-dark.png';
                    ...
                    <Grid container spacing={1.5}>
                        ...
                        <Grid item xs={12}>
                            <Typography variant="h4" sx={{ fontWeight: 400 }} align="center">
                                Shmooz has features for Chats, Events, Oranizer Dashboard
                            </Typography>
                        </Grid>
                    </Grid>
                </Grid>
                <Grid item xs={12}>
                    ...
                    >
                        ...
                        >
                            <Items
                                title="Dashboard"
                                image={theme.palette.mode === 'dark' ? SliderDashboardDark : SliderDashboardLight}
