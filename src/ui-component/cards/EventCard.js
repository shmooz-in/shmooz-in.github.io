...
const EventCard = ({ id, time, color, name, image, description, offerPrice, salePrice, rating }) => {
        ...
        <>
            {isLoading ? (
                ...
                >
                    ...
                    />
                    <Button variant="contained" sx={{ minWidth: 0, position: 'absolute', top: 0 }} onClick={addCart} aria-label="Favorite">
